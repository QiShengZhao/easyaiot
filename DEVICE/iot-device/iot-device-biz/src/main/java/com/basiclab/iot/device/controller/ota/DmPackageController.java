...
public class DmPackageController extends BaseController {
    ...
    @Parameter(in = ParameterIn.PATH, name = "packageId", description = "版本包ID", required = true)
    @Operation(summary = "删除版本包")
    ...
    @Parameter(in = ParameterIn.PATH, name = "type", description = "包类型[0:app,1:系统,2:电控]")
    @Operation(summary = "根据包类型获取版本列表")
