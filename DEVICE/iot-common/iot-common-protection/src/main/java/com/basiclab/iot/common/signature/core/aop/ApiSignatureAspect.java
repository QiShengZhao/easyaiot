...
public class ApiSignatureAspect {
    ...
    private final ApiSignatureRedisDAO signatureRedisMapper;
    ...
    public boolean verifySignature(ApiSignature signature, HttpServletRequest request) {
        ...
        String appSecret = signatureRedisMapper.getAppSecret(appId);
        ...
        signatureRedisMapper.setNonce(nonce, signature.timeout() * 2, signature.timeUnit());
        return true;
    }
    ...
    private boolean verifyHeaders(ApiSignature signature, HttpServletRequest request) {
        ...
        return signatureRedisMapper.getNonce(nonce) == null;
    }
