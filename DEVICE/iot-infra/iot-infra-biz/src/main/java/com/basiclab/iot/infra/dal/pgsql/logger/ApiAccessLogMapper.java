package com.basiclab.iot.infra.dal.pgsql.logger;
...
public interface ApiAccessLogMapper extends BaseMapperX<ApiAccessLogDO> {
     ...
     * @return 删除条数
     */
    @Delete("DELETE FROM infra_api_access_log WHERE id IN (SELECT id FROM infra_api_access_log WHERE create_time < #{createTime} LIMIT #{limit})")
